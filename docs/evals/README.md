...
- [`week6-tasks.md`](./week6-tasks.md) — Week6(supervisor→Nana/Kana 하위 agent 위임, 공통 가능 시간 후보 검증·최종 결정) 신규 기능 task 6개. 골든 패스 3 / 경계 사례 1 / 부정 사례 1 / 추가과제 1, TODO 구현 전에 먼저 정의(eval-driven development)해 전부 미검증. week1~5 task는 `week5-tasks.md`를 그대로 이어받음.
...
| `week6-tasks.md` | Week6 신규 기능 (supervisor→Nana/Kana 위임, 공통 가능 시간 후보 검증·최종 결정) | 6 |
