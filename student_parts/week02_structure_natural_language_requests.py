...
def week02_prompt_parts() -> list[str]:
    ...
    return [
        *week01_prompt_parts(),
        ...
        "kind 판별 규칙:",
        "- personal_schedule: 개인 일정이다. 나 혼자 하는 일정과 상대 1명과의 약속, 방문, 예약처럼 날짜나 시간이 있는 요청에 사용한다.",
        "- group_schedule: 여러 사람이 함께하는 일정이다. 나를 제외한 참석자가 2명 이상이거나 '회의', '모임', '팀' 같은 집단 표현이 있는 요청에 사용한다.",
        "- 참석자 수를 셀 때 나(사용자)는 포함하지 않는다. '지수와 저녁 약속'은 상대가 1명이므로 members=['지수']인 personal_schedule이다.",
