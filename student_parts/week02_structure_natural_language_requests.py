...
class StructuredRequest(BaseModel):
    ...
    members: list[str] = Field(default_factory=list, description="일정 창가자 목록")
...
def week02_prompt_parts() -> list[str]:
    ...
    return [
        *week01_prompt_parts(),
        ...
        "사용자의 자연어 요청을 kind, title, date, start_time, end_time, members, priority, original_text Feild로 Structured_response를 생성한다.""",
