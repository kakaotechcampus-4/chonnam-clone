...
def search_personal_reference_hits(
    ...
    *,
    ...
    hits = reference_store.search_personal_references(query,safe_limit(top_k))
...
def search_saved_request_rows(
    ...
    *,
    ...
    rows = sqlite_store.search_saved_requests(query,None,safe_limit(top_k))
...
def search_personal_references(query: str, top_k: int = 2) -> str:
    ...
    result = search_personal_reference_hits(REFERENCE_STORE,query=query,top_k=top_k)
...
def search_saved_requests(query: str, top_k: int = 3) -> str:
    ...
    result = search_saved_request_rows(SQLITE_STORE,query=query,top_k=top_k)
...
def week04_prompt_parts() -> list[str]:
    ...
    return [
        *week03_prompt_parts(),
        ...
        - 참고자료와 관련된 요청 사항은 search_personal_references와 add_personal_reference 만 사용한다.
        ...
        - 조회/수정/삭제 방식을 진행하기 전에 search_personal_references, search_saved_requests 를 사용하여 필요한 정보를 탐색한다.
        """,
